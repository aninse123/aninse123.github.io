/* ===== LANGUAGE ===== */
// First-visit default: Portuguese. Only used when no saved preference exists
// yet; a manual choice via the language switcher always wins afterward via
// localStorage.
let currentLang = localStorage.getItem('dp_lang') || 'pt';
